...
@section('content')
<div class="page-banner overlay-dark bg-image" style="background-image: {{  asset('User/assets/img/bg_image_1.jpg')}};">
      ...
      <div class="row">
        <div class="col-md-4 py-3 wow zoomIn">
          <div class="card-service">
            ...
            <p><span>We</span>-Raise Brilliant students</p>
          </div>
        </div>
        <div class="col-md-4 py-3 wow zoomIn">
          <div class="card-service">
            ...
            <p><span>We</span>-Give standard Test</p>
          </div>
        </div>
        <div class="col-md-4 py-3 wow zoomIn">
          <div class="card-service">
            ...
            <p><span>Start</span>-Your Aptitude test now</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 wow fadeInUp">
          <h1 class="text-center mb-3">Welcome to Scaffold Aptitude test</h1>
          <div class="text-lg">
